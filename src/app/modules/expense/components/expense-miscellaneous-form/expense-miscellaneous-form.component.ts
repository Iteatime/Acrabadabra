...
export class ExpenseMiscellaneousFormComponent
  implements OnInit, AfterViewInit
{
  ...
  ngOnInit() {
    ...
    this.miscellaneousTypes =
      this.miscellaneousExpensesService.miscellaneousTypes;
    this.vatRates = [];
  ...
  onSubmit() {
    if (this.form.valid) {
      if (
        this.miscellaneousExpensesService.vatDeductible(this.misc) &&
        this.misc.selectedType === 1
      ) {
        this.misc.tvaRate =
          this.miscellaneousExpensesService.miscellaneousTypes[
            this.misc.selectedType
          ].vat;
      }
      if (
        !this.miscellaneousExpensesService.vatDeductible(this.misc) &&
        this.misc.selectedType !== 5
      ) {
        this.misc.tvaRate =
          this.miscellaneousExpensesService.miscellaneousTypes[
            this.misc.selectedType
